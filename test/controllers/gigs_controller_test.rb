...
class GigsControllerTest < ActionController::TestCase
  ...
  test "should create gig" do
    assert_difference('Gig.count') do
      post :create, gig: { description: @gig.description, price_audition: @gig.price_audition, price_gig: @gig.price_gig, script: @gig.script, title: @gig.title }
    end
  ...
  test "should update gig" do
    patch :update, id: @gig, gig: { description: @gig.description, price_audition: @gig.price_audition, price_gig: @gig.price_gig, script: @gig.script, title: @gig.title }
    assert_redirected_to gig_path(assigns(:gig))
  end
